...
const FinalCTA: React.FC = () => {
  return (
    <section className="py-32 px-4 bg-white dark:bg-brandBlack transition-colors duration-300" id="waitlist-final">
      <div className="max-w-7xl mx-auto relative reveal">
        {/* Main Background Card - Flip colors from main theme for pop */}
        <div className="bg-brandBlack dark:bg-white rounded-[4rem] p-12 lg:p-24 text-center text-white dark:text-brandBlack relative overflow-hidden shadow-2xl transition-colors duration-300">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl opacity-70 mb-12 font-medium max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center items-center gap-10 opacity-60">
              ...
              <div className="w-px h-10 bg-white/10 dark:bg-brandBlack/10 hidden sm:block" />
              <div className="flex flex-col items-center">
